...
gulp.task('watch', function() {
	gulp.watch('app/sass/**/*.sass', gulp.parallel('css-libs')).on('change', browserSync.reload) // Наблюдение за sass файлами в папке sass
	gulp.watch('app/templates/**/*.html', gulp.parallel('rigger')).on('change', browserSync.reload) // Наблюдение за HTML файлами в корне проекта
	gulp.watch('app/js/main.js', gulp.parallel('scripts')).on('change', browserSync.reload);   // Наблюдение за JS файлами в папке js
});

gulp.task('default', gulp.parallel('watch', 'browser-sync', 'rigger', 'css-libs', 'scripts'));
...
gulp.task('build', gulp.parallel('clean', 'rigger', 'sass', 'css-libs', 'scripts', function() {
